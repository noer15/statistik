...
class Jabatan extends CI_Controller {
	...
	public function index()
	{
		...
		$list = $this->db->query("Select a.* from m_jabatan a ")->result_object();		

		$data['data']	 = $list;
		$data['page']	 ='masterjabatan';
		$data['subpage'] ='list';
	...
	public function edit($id){
		$data['data'] = $this->db->query("Select a.* from m_jabatan a where id='".$id."'")->result_object();
	...
	public function update(){
		...
		$this->db->where('id',$id);
	    $this->db->update('m_jabatan',$post_data);
	...
	public function delete($id){
		// delete detail dasar
		$result = $this->db->delete('m_jabatan', array('id' => $id));
        print_r($nip);
	 }
            	...
            	'aksi' => '<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="Jabatan/edit/'. $value->id.'">
