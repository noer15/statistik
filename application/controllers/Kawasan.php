...
class Kawasan extends CI_Controller {
	...
	public function index()
	{
		...
		$list = $this->db->query("Select a.* from m_kawasan_hutan a ")->result_object();		
	...
	public function store(){
	    ...
	    $this->db->insert('m_kawasan_hutan',$post_data);

		redirect(base_url().'Kawasan');
	}

	public function edit($id){
		$data['data'] = $this->db->query("Select a.* from m_kawasan_hutan a where id='".$id."'")->result_object();
	...
	public function update(){
		...
		$this->db->where('id',$id);
	    $this->db->update('m_kawasan_hutan',$post_data);
	...
	public function delete($id){
		// delete detail dasar
		$result = $this->db->delete('m_kawasan_hutan', array('id' => $id));
        print_r($nip);
	 }
	...
	public function getdata(){
		...
		$sql = " Select a.* from m_kawasan_hutan a ";
            	...
            	'aksi' => '<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="Kawasan/edit/'. $value->id.'">
