...
class Penataan extends CI_Controller {
	private $judul = "Penataan Batas Kawasan";
	...
	public function index()
	{
		...
		$list = $this->db->query("Select a.* from penataan a ")->result_object();		
		...
		$this->load->view('penataan/index',$data);
	}	
	...
	public function store(){
		...
		$this->isPost();
        $this->M_jasa->input_penataan($_POST,'penataan');
		redirect(base_url().'penataan');
	}

	public function edit($id){
		$dat = $this->db->query("SELECT * FROM penataan LEFT JOIN fungsi_kawasan ON penataan.id_fungsi = fungsi_kawasan.id where penataan.id='".$id."'")->row();
	...
	public function update(){
		$this->isPost();
        $this->M_jasa->update_penataan($_POST);
		redirect(base_url().'penataan');
	}

	public function delete($id){
		// delete detail dasar
		$result = $this->db->delete('penataan', array('id' => $id));
        print_r($nip);
	 }

	 public function getdata(){

		$sql = "SELECT * FROM penataan LEFT JOIN fungsi_kawasan ON penataan.id_fungsi = fungsi_kawasan.id";
		...
		$page = $this->db->query($sql.
				" WHERE nama_penataan like '%".$filter."%' ".
				" ORDER BY ".$orderBy.
        ...
        foreach ($list as $key => $value) {
            ...
            $row = array(
            	'nama'=> $value->nama_penataan,
            	'fungsi'=> $value->nama_kawasan,
            	...
            	'aksi' => '<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="penataan/edit/'. $value->id.'">
