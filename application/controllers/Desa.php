...
class Desa extends CI_Controller
{
	...
	public function getKelompokTani($desaId)
	{
		$kelompok = $this->db->query("SELECT id,nama FROM kelompok_tani WHERE desa_id = " . $desaId)->result_array();
		print_r(json_encode($kelompok));
	}
}
