...
class Sdmsarpras extends CI_Controller {
	private $judul = "Master SDM dan Sarana Prasarana";
	...
	public function index()
	{
		...
		$list = $this->db->query("Select a.* from m_sdm_sarpras a ")->result_object();		

		$data['data']	 = $list;
		$data['page']	 ='sdmsarpras';
		$data['subpage'] ='list';
		$data['judul']	 =$this->judul;
		$data['header']	 =$this->judul;
		$this->load->view('sdmsarpras/index',$data);
	}	
	...
	public function store(){
	    ...
	    $this->db->insert('m_sdm_sarpras',$post_data);

		redirect(base_url().'Sdmsarpras');
	}

	public function edit($id){
		$data['data'] = $this->db->query("Select a.* from m_sdm_sarpras a where id='".$id."'")->result_object();
	...
	public function update(){
		...
		$this->db->where('id',$id);
	    $this->db->update('m_sdm_sarpras',$post_data);
	...
	public function delete($id){
		// delete detail dasar
		$result = $this->db->delete('m_sdm_sarpras', array('id' => $id));
        print_r($nip);
	 }
	...
	public function getdata(){
		...
		$sql = " Select a.* from m_sdm_sarpras a ";
            	...
            	'aksi' => '<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="Sdmsarpras/edit/'. $value->id.'">
