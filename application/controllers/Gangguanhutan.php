...
class Gangguanhutan extends CI_Controller {
	private $judul = "Jenis Gangguan Hutan ";
	...
	public function index()
	{
		...
		$this->load->view('gangguanhutan/index',$data);
	}	
	...
	public function store(){
	    ...
	    $this->db->insert('m_jenisgangguan',$post_data);

		redirect(base_url().'Gangguanhutan');
	}

	public function edit($id){
		$data['data'] = $this->db->query("Select a.* from m_jenisgangguan a where id='".$id."'")->result_object();
	...
	public function update(){
		...
		$this->db->where('id',$id);
	    $this->db->update('m_jenisgangguan',$post_data);
	...
	public function delete($id){
		// delete detail dasar
		$result = $this->db->delete('m_jenisgangguan', array('id' => $id));
        print_r($nip);
	 }

	 public function getdata(){

		$sql = " Select a.* from m_jenisgangguan a ";
		...
		$page = $this->db->query($sql.
				" WHERE a.jenis_gangguan like '%".$filter."%' ".
				" ORDER BY ".$orderBy.
            	...
            	'aksi' => '<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="Gangguanhutan/edit/'. $value->id.'">
