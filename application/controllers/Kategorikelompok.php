...
class Kategorikelompok extends CI_Controller {
	private $judul = "Master Kategori Kelompok ";
	...
	public function index()
	{
		...
		$list = $this->db->query("Select a.* from m_kategori_kelompok a ")->result_object();		

		$data['data']	 = $list;
		$data['page']	 ='masterkategorikel';
		$data['subpage'] ='list';
		$data['judul']	 =$this->judul;
		$data['header']	 =$this->judul;
		$this->load->view('master/kategorikelompok/index',$data);
	}	
	...
	public function store(){
	    ...
	    $this->db->insert('m_kategori_kelompok',$post_data);

		redirect(base_url().'Kategorikelompok');
	}

	public function edit($id){
		$data['data'] = $this->db->query("Select a.* from m_kategori_kelompok a where id='".$id."'")->result_object();
	...
	public function update(){
		...
		$this->db->where('id',$id);
	    $this->db->update('m_kategori_kelompok',$post_data);
	...
	public function delete($id){
		// delete detail dasar
		$result = $this->db->delete('m_kategori_kelompok', array('id' => $id));
        print_r($nip);
	 }

	public function getdata(){

		$sql = " Select a.* from m_kategori_kelompok a ";
            	...
            	'aksi' => '<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="Kategorikelompok/edit/'. $value->id.'">
