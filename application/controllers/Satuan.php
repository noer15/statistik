...
class Satuan extends CI_Controller {
	...
	public function index()
	{
		...
		$list = $this->db->query("Select a.* from m_satuan a ")->result_object();		

		$data['data']	 = $list;
		$data['page']	 ='mastersatuan';
		$data['subpage'] ='list';
	...
	public function store(){
	    ...
	    $this->db->insert('m_satuan',$post_data);

		redirect(base_url().'satuan');
	}

	public function edit($id){
		$data['data'] = $this->db->query("Select a.* from m_satuan a where id='".$id."'")->result_object();
	...
	public function update(){
		...
		$this->db->where('id',$id);
	    $this->db->update('m_satuan',$post_data);
	...
	public function delete($id){
		...
		// delete detail dasar
		$result = $this->db->delete('m_satuan', array('id' => $id));
        print_r($nip);
	 }
            	...
            	'aksi' => '<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="Satuan/edit/'. $value->id.'">
