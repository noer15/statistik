...
class Konservasi extends CI_Controller {
	private $judul = "Master Jenis Konservasi";
	...
	public function index()
	{
		...
		$list = $this->db->query("Select a.* from m_kawasan_konservasi a ")->result_object();		

		$data['data']	 = $list;
		$data['page']	 ='konservasi';
		$data['subpage'] ='list';
		$data['judul']	 =$this->judul;
		$data['header']	 =$this->judul;
		$this->load->view('konservasi/index',$data);
	}	
	...
	public function store(){
	    ...
	    $this->db->insert('m_kawasan_konservasi',$post_data);

		redirect(base_url().'Konservasi');
	}

	public function edit($id){
		$data['data'] = $this->db->query("Select a.* from m_kawasan_konservasi a where id='".$id."'")->result_object();
		
		$data['page'] 	 = 'konservasi';
		$data['subpage'] ='edit';		
		$data['judul']	 ='Jenis Konservasi';
	...
	public function update(){
		...
		$this->db->where('id',$id);
	    $this->db->update('m_kawasan_konservasi',$post_data);
	...
	public function delete($id){
		// delete detail dasar
		$result = $this->db->delete('m_kawasan_konservasi', array('id' => $id));
        print_r($nip);
	 }
	...
	public function getdata(){
		...
		$sql = " Select a.* from m_kawasan_konservasi a ";
            	...
            	'aksi' => '<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="Konservasi/edit/'. $value->id.'">
