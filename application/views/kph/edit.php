...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>Kph/update" class="form-horizontal" method="post">
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label">Nama Pengelola</label>
							<div class="col-lg-10">
						...
						<div class="text-left">
							<a  href="<?php echo base_url();?>Kph" class="btn btn-danger">Batal</a>
