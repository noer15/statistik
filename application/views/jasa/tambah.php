...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>jasa/store" class="form-horizontal" method="post">
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Jenis Gangguan" name="nama_jasa">
							</div>
						</div>
