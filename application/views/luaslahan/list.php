...
<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			...
			<a href="<?php echo base_url();?>luaslahan/tambah" class="btn btn-primary">Tambah</a>			
			<br><br>
			<table>
				<tr>
					...
					<td width="100%">
						<div class="col-lg-5">
			                <select name="tahun"  id="tahun" class="form-control select-search" 
			...
			<table class="table datatable-basic table-hover table-bordered striped" id="table-luas">
			<thead>
						...
						<ul class="icons-list">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a href="<?php echo base_url();?>luaslahan/edit/<?php echo $value->id;?>">
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	$('body').on('click', ".submit", function () {
            ...
            $.ajax({
            	url: baseurl+'luaslahan/delete/'+id,
                type: 'DELETE',
