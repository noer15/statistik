...
<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<a href="<?php echo base_url();?>penataan/tambah" class="btn btn-primary">Tambah</a>
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	table = $('#table-desa').DataTable({
            ...
            ajax: {
            	data:function(d){},
                url: base_url+'penataan/getdata'                
            },
            columns: [
                {data: "nama", width : "140px"},
                {data: "fungsi"},
                {data: "panjang"},
                {data: "luas"},
    	...
    	$('body').on('click', ".submit", function () {
            ...
            $.ajax({
            	url: base_url+'penataan/delete/'+id,
                type: 'DELETE',
