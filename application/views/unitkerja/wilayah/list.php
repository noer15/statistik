...
<div class="content">
	...
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h5 class="panel-title"><?php echo $header;?> <span class="text-primary-600">( <?php echo $datauk[0]->nama; ?>) </span> </h5>
		...
		<div class="panel-body">
			...
			<a href="<?php echo base_url();?>unitkerja" class="btn btn-danger">Kembali</a>			
			<a href="<?php echo base_url();?>/unitkerjawilayah/tambah/<?php echo $datauk[0]->id; ?>" class="btn btn-primary">Tambah</a>
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	var unitkerjaId = "<?php echo $datauk[0]->id; ?>";
    	...
    	table = $('#table-penyuluh').DataTable({
            ...
            ajax: {
            	data:function(d){
            		d.unitkerjaId = unitkerjaId
            	},
                url: base_url+'unitkerjawilayah/getdata'                
            },
            columns: [
    	...
    	$('body').on('click', ".submit", function () {
            ...
            $.ajax({
            	url: base_url+'unitkerjawilayah/delete/'+id,
                type: 'DELETE',
