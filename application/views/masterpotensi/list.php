...
<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<a href="<?php echo base_url();?>Jenispotensi/tambah" class="btn btn-primary">Tambah</a>
		...
		<?php foreach($data as $key => $value){ ?>
			<tr>
				...
				<td width="150px"><?php if($value->jenis==1) { echo "Kayu"; }else{ echo"Bukan Kayu"; } ?></td>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="<?php echo base_url();?>Jenispotensi/edit/<?php echo $value->id;?>">
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	table = $('#table-desa').DataTable({
            ...
            ajax: {
            	data:function(d){},
                url: base_url+'Jenispotensi/getdata'                
            },
            columns: [
                {data: "id", width : "100px"},
                {data: "nama"},
                {data: "jenis", width:"150px"},
    	...
    	$('body').on('click', ".submit", function () {
            ...
            $.ajax({
            	url: base_url+'Jenispotensi/delete/'+id,
                type: 'DELETE',
