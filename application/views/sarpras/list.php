...
<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<a href="<?php echo base_url();?>sarpras/tambah" class="btn btn-primary">Tambah</a>
		

		<table class="table datatable-basic table-hover table-bordered striped" id="sarpras">
		<thead>
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	$('body').on('click', ".submit", function () {
            ...
            $.ajax({
            	url: base_url+'sarpras/delete/'+id,
                type: 'DELETE',
