...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>Pengukuhankh/update" class="form-horizontal" method="post">
				<div class="panel panel-flat">
                    ...
                    <div class="form-group">
                            ...
                            <select name="kawasan"  id="kawasan" class="select-search" required
                                ...
                                <?php foreach ($kawasan as $key => $value) { ?>
                                    <option value="<?php echo $value->id?>"
                                        <?php if($data[0]->kawasan_id==$value->id){ echo "selected"; } ?> >
                                        <?php echo $value->nama?>                                           
                                    </option>
                                <?php }  ?>
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    placeholder="Nomor SK Penunjukan" 
                                    name="penunjukan_no" 
                                    value="<?php echo $data[0]->penunjukan_no; ?>"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    ...
                                    name="penunjukan_date" id="penunjukan_date"
                                    value="<?php echo $data[0]->penunjukan_date; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" 
                                    placeholder="Luas" name="penunjukan_luas"
                                    value="<?php echo $data[0]->penunjukan_luas; ?>"  required>
                            </div>
                            <div class="col-lg-5">
                                <select name="penunjukan_satuan_luas"  
                                    ...
                                    <?php foreach ($satuan as $key => $value) { ?>
                                        <option value="<?php echo $value->id?>"
                                            <?php if($data[0]->penunjukan_satuan_luas==$value->id){ echo "selected"; } ?> >
                                            <?php echo $value->nama?>                                           
                                        </option>
                                    <?php }  ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->batb_date; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <select class="form-control" name="batb_pilihan" id="batb_pilihan">
                                    <option value="Darat" <?php if($data[0]->batb_pilihan=="Darat") { echo "selected";  } ?> >Darat</option>
                                    <option value="Laut" <?php if($data[0]->batb_pilihan=="Darat") { echo "selected";  } ?> >Laut</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->batb_panjang; ?>" >
                            </div>
                            <div class="col-lg-5">
                                <select name="batb_satuan_panjang"  
                                    ...
                                    <?php foreach ($satuan as $key => $value) { ?>
                                        <option value="<?php echo $value->id?>"
                                            <?php if($data[0]->batb_satuan_panjang==$value->id){ echo "selected"; } ?> >
                                            <?php echo $value->nama?>                                           
                                        </option>
                                    <?php }  ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->batb_luas; ?>" >
                            </div>
                            <div class="col-lg-5">
                                <select name="batb_satuan_luas"  
                                    ...
                                    <?php foreach ($satuan as $key => $value) { ?>
                                        <option value="<?php echo $value->id?>"
                                            <?php if($data[0]->batb_satuan_luas==$value->id){ echo "selected"; } ?> >
                                            <?php echo $value->nama?>                                           
                                        </option>
                                    <?php }  ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->tetap_no; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->tetap_date; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <select class="form-control" name="tetap_pilihan" id="tetap_pilihan">
                                    <option value="Darat" <?php if($data[0]->tetap_pilihan=="Darat") { echo "selected";  } ?> >Darat</option>
                                    <option value="Laut" <?php if($data[0]->tetap_pilihan=="Darat") { echo "selected";  } ?> >Laut</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->tetap_panjang; ?>" >
                            </div>
                            <div class="col-lg-5">
                                <select name="tetap_satuan_panjang"  
                                    ...
                                    <?php foreach ($satuan as $key => $value) { ?>
                                        <option value="<?php echo $value->id?>"
                                            <?php if($data[0]->tetap_satuan_panjang==$value->id){ echo "selected"; } ?> >
                                            <?php echo $value->nama?>                                           
                                        </option>
                                    <?php }  ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->tetap_luas; ?>" >
                            </div>
                            <div class="col-lg-5">
                                <select name="tetap_satuan_luas"  
                                    ...
                                    <?php foreach ($satuan as $key => $value) { ?>
                                        <option value="<?php echo $value->id?>"
                                            <?php if($data[0]->tetap_satuan_luas==$value->id){ echo "selected"; } ?> >
                                            <?php echo $value->nama?>                                           
                                        </option>
                                    <?php }  ?>
