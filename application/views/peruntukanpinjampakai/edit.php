...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>Peruntukanpinjampakai/update" class="form-horizontal" method="post">
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label">Peruntukan Pinjam Pakai</label>
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Peruntukan Pinjam Pakai" name="nama"
									value="<?php echo $data[0]->nama?>">
							</div>
						</div>
						
						<div class="text-left">
							<a  href="<?php echo base_url();?>Peruntukanpinjampakai" class="btn btn-danger">Batal</a>
