...
<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<a href="<?php echo base_url();?>Konservasi/tambah" class="btn btn-primary">Tambah</a>
		...
		<thead>
			<tr class="bg-teal-400">
				<th>Kode</th>
				<th>Jenis Kawasan Konservasi</th>
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	table = $('#table-desa').DataTable({
            ...
            ajax: {
            	data:function(d){},
                url: base_url+'Konservasi/getdata'                
            },
            columns: [
    	...
    	$('body').on('click', ".submit", function () {
            ...
            $.ajax({
            	url: base_url+'Konservasi/delete/'+id,
                type: 'DELETE',
