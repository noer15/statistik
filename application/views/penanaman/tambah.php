...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>penanaman/store" class="form-horizontal" method="post">
				<div class="panel panel-flat">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Luas Pohon" name="luas">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" readonly placeholder="Tahun" name="tahun" value="<?=date('Y')?>">
							</div>
						</div>
