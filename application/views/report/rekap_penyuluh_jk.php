...
<table width="100%" border="0" style="font-size: 10pt;">
	...
	<div align="center">
	  <br>
	  <strong>REKAP DATA PENYULUH BERDASARKAN JENIS KELAMIN</strong><br>	  
	  <br>
	</div>
		...
		<div class="row">
	 	<table border="1" style="table-layout:fixed; width:100%;border-collapse: collapse;">
	 		<tr>
	 			...
	 			<td style="width: 20%;text-align: center;"><b>Laki-Laki</b></td>
	 			<td style="width: 20%;text-align: center;"><b>Perempuan</b></td>
	 		</tr>
	 		<?php
	 		  foreach ($data as $key => $value) { ?>
	 		  	<tr>
	 		  		...
	 		  		<td align="center"><?php echo ($value->asn_laki+$value->pksm_laki); ?></td>
	 		  		<td align="center"><?php echo ($value->asn_perempuan+$value->pksm_perempuan); ?></td>
	 		  	</tr>
	 		 <?php } ?>
	 	</table>
		</div>		
