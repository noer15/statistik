...
<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<a href="<?php echo base_url();?>/Kecamatan/tambah" class="btn btn-primary">Tambah</a>		

		<table class="table datatable-basic table-hover table-bordered striped" id="table-kec">
		<thead>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="<?php echo base_url();?>Kecamatan/edit/<?php echo $value->id;?>">
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	table = $('#table-kec').DataTable({
            ...
            ajax: {
            	data:function(d){},
                url: base_url+'Kecamatan/getdata'                
            },
            columns: [
