...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>Pinjampakai/update" class="form-horizontal" method="post">
				<div class="panel panel-flat">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-lg-10">
                            <select name="kab"  id="kab" class="select-search" disabled 
                                data-placeholder="Pilih Kabupaten">
                                <?php foreach ($kabupaten as $key => $value) { ?>
                                    <option value="<?php echo $value->id?>"
                                        <?php if($data[0]->kabupaten_id==$value->id){ echo "selected"; } ?> >
                                        <?php echo $value->nama?>                                           
                                    </option>
                                <?php }  ?>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-lg-10">
                            <select name="kec"  id="kec" class="select-search" disabled 
                                data-placeholder="Pilih Kecamatan">
                                <?php foreach ($kecamatan as $key => $value) { ?>
                                    <option value="<?php echo $value->id?>"
                                        <?php if($data[0]->kecamatan_id==$value->id){ echo "selected"; } ?> >
                                        <?php echo $value->nama?>                                           
                                    </option>
                                <?php }  ?>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-lg-10">
                            <select name="desa"  id="desa" class="select-search" disabled 
                                data-placeholder="Pilih Desa">
                                <?php foreach ($desa as $key => $value) { ?>
                                    <option value="<?php echo $value->id?>"
                                        <?php if($data[0]->desa_id==$value->id){ echo "selected"; } ?> >
                                        <?php echo $value->nama?>                                           
                                    </option>
                                <?php }  ?>
                        ...
                        <div class="col-lg-10">
                            <select name="peruntukan_id"  
                                ...
                                <?php foreach ($peruntukan as $key => $value) { ?>
                                    <option value="<?php echo $value->id?>"
                                        <?php if($data[0]->peruntukan_id==$value->id){ echo "selected"; } ?> >
                                        <?php echo $value->nama?>                                           
                                    </option>
                                <?php }  ?>
                            </select>
                    ...
                    <!-- <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    placeholder="Nomor Permohonan " name="permohonan_no" 
                                    value="<?php echo $data[0]->permohonan_no; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    ...
                                    name="permohonan_date" id="permohonan_date" 
                                    value="<?php echo $data[0]->permohonan_date; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->persetujuan_no; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" 
                                    ...
                                    value="<?php echo $data[0]->persetujuan_date; ?>" >
                            </div>
                        </div>
