...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>Kategorikelompok/update" class="form-horizontal" method="post">
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						...
						<div class="text-left">
							<a  href="<?php echo base_url();?>Kategorikelompok" class="btn btn-danger">Batal</a>
