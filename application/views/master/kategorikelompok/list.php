...
<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<a href="<?php echo base_url();?>Kategorikelompok/tambah" class="btn btn-primary">Tambah</a>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="<?php echo base_url();?>Kategorikelompok/edit/<?php echo $value->id;?>">
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	table = $('#table-desa').DataTable({
            ...
            ajax: {
            	data:function(d){},
                url: base_url+'Kategorikelompok/getdata'                
            },
            columns: [
    	...
    	$('body').on('click', ".submit", function () {
            ...
            $.ajax({
            	url: base_url+'Kategorikelompok/delete/'+id,
                type: 'DELETE',
