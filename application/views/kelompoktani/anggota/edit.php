...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>Anggotakelompoktani/update" class="form-horizontal" method="post">
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-lg-5">
								<input type="number" class="form-control" placeholder="Umur" name="umur" id="umur" required readonly value="<?php echo $data[0]->umur?>">
							</div>
                    ...
                    <div class="form-group">
                            ...
                            <select name="jabatan"  id="jabatan" class="form-control" required
                                ...
                                <?php foreach ($jabatan as $key => $value) { ?>
                                    <option value="<?php echo $value->id?>"
                                    	<?php if($data[0]->jabatan==$value->id){ echo "selected"; } ?> >
                                        <?php echo $value->nama?>                                           
                                    </option>
                                <?php }  ?>
