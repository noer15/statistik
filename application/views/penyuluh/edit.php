...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>Penyuluh/update" class="form-horizontal" method="post">
				<div class="panel panel-flat">
					...
					<!-- <div class="form-group">
                        ...
                        <div class="form-group" id="pekerjaan">
                            ...
                            <div class="col-lg-10">
                                ...
                                value="<?php echo $data[0]->pekerjaan; ?>">
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                    ...
                                    placeholder="yyyy-mm-dd" value="<?php echo $data[0]->tgl_lahir; ?>">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="agama"  id="agama" class="form-control" required
                                ...
                                <?php foreach ($agama as $key => $value) { ?>
                                    <option value="<?php echo $value->id?>" 
                                        <?php if($data[0]->agama==$value->id){ echo "selected"; } ?> >
                                        <?php echo $value->nama?>                                           
                                    </option>
                                <?php }  ?>
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <select id="jk" name="jk" class="form-control">
                                 <option value="L" <?php if($data[0]->jk=='L'){ echo "selected"; } ?> 
                                         >Laki-Laki</option> 
                                 <option value="P" <?php if($data[0]->jk=='P'){ echo "selected"; } ?>  >Perempuan</option> 
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            ...
                            <!-- <select id="penyuluhdari" name="penyuluhdari" class="form-control" disabled>
                             <option value="PKSM" <?php if($data[0]->penyuluh_dari=='PKSM'){ echo "selected"; } ?>>PKSM</option>
                             <option value="ASN" <?php if($data[0]->penyuluh_dari=='ASN'){ echo "selected"; } ?>>ASN</option> 
                            </select> -->
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jabatanpenyuluh"  id="jabatanpenyuluh" class="form-control" required
                            ...
                            <?php foreach ($jabpenyuluh as $key => $value) { ?>
                                <option value="<?php echo $value->id?>"
                                    <?php if($data[0]->jabatan_penyuluh==$value->id){ echo "selected"; } ?> >
                                    <?php echo $value->nama?>                                           
                                </option>
                            <?php }  ?>
