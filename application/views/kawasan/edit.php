...
<div class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Basic layout-->
			<form action="<?php echo base_url();?>Kawasan/update" class="form-horizontal" method="post">
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label">Nama Kawasan Hutan</label>
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Nama Kawasan Hutan" name="nama"
									value="<?php echo $data[0]->nama?>">
							</div>
						</div>
						
						<div class="text-left">
							<a  href="<?php echo base_url();?>Kawasan" class="btn btn-danger">Batal</a>
