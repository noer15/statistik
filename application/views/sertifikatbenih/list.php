<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<a href="<?php echo base_url();?>sertifikatbenih/tambah" class="btn btn-primary">Tambah</a>
		...
		<?php foreach($data as $key => $value){ ?>
			<tr>
				<td><?php echo $value->no_sb; ?></td>
				<td><?php echo $value->kelas; ?></td>
				<td><?php echo $value->nama_pemilik; ?></td>
				<td><?php echo $value->jenis_benih; ?></td>
				<td><?php echo $value->luas; ?></td>
				<td><?php echo $value->satuan_luas; ?></td>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="<?php echo base_url();?>sertifikatbenih/edit/<?php echo $value->id;?>">
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	$('body').on('click', ".submit", function () {
            ...
            $.ajax({
            	url: baseurl+'sertifikatbenih/delete/'+id,
                type: 'DELETE',
